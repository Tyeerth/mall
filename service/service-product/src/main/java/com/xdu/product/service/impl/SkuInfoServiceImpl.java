...
import com.xdu.common.exception.SsyxException;
...
import com.xdu.product.mapper.SkuInfoMapper;
import com.xdu.product.service.SkuAttrValueService;
import com.xdu.product.service.SkuImageService;
import com.xdu.product.service.SkuInfoService;
import com.xdu.product.service.SkuPosterService;
import com.xdu.rabbitmq.constant.MqConst;
import com.xdu.rabbitmq.service.RabbitService;
import com.xdu.vo.product.SkuInfoQueryVo;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoMapper, SkuInfo> implements SkuInfoService {
    ...
    /**
     * ioc容器里的bean是通过反射的方式获得的，所以没有具体的对象，只有在程序运行时才知道对象是谁，idea找不到具体对象就会报错
     */
    @Autowired // TODO rabbitMQ
